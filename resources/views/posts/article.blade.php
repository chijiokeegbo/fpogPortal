    ...
    <div class="container my-0 bg-dark text-white">
        <h1 class="text-center">Yes</h1>
            ...
            @section('content')
            <div class="container" style="margin-top: 7%"><br>
                <div class="row bg-white">
                    ...
                    <div class="col-sm-6 border-top-0"><br>
                        <h4 class="text-center">News Flash</h4><hr>
                        <div class="jumbotron-fluid">
                              <div class="well">
                              <h4>{{$post->title}}</h4>
                              <small>Posted on {{$post->created_at}}</small><hr>
                              <p>{{$post->body}}</p>
                              <p>{{$post->body}}</p><hr>
                              <small> Signed By {{$post->officer}}</small><hr>
